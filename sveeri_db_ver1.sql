...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2026 at 12:10 PM
...
CREATE TABLE `users` (
  ...
  `forgotpassword_token_expires` datetime DEFAULT NULL,
...
--
ALTER TABLE `ballots`
  ADD CONSTRAINT `ballots_ibfk_1` FOREIGN KEY (`session_id`) REFERENCES `sessions` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `ballots_ibfk_2` FOREIGN KEY (`scanned_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
ALTER TABLE `candidates`
  ...
  ADD CONSTRAINT `candidates_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
--
ALTER TABLE `votes`
  ADD CONSTRAINT `votes_ibfk_1` FOREIGN KEY (`ballot_id`) REFERENCES `ballots` (`id`) ON DELETE CASCADE,
